...
const iconMap: { [key: string]: JSX.Element } = {
  "/": <Home size={18} className="text-blue-500" />, // 🟦 น้ำเงิน
  "/products": <Package size={18} className="text-green-500" />, // 🟩 เขียว
  "/about": <User size={18} className="text-purple-500" />, // 🟪 ม่วง
  "/contact": <Info size={18} className="text-red-500" />, // 🟥 แดง
};
