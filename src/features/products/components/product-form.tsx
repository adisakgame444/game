...
const ProductForm = ({ categories, product }: ProductFormProps) => {
  ...
  const [form, setForm] = useState({
    ...
    cod: product?.cod ?? false, // default จาก product
  });
    ...
    <Card className="max-w-4xl mx-auto">
      ...
      >
        <CardContent className="flex flex-col gap-6">
          ...
          <div className="mb-4">
            <label htmlFor="cod" className="block mb-1 font-medium">
              บริการเก็บเงินปลายทาง
            </label>
            <select
              id="cod"
              name="cod"
              value={form.cod ? "true" : "false"}
              onChange={(e) =>
                setForm({ ...form, cod: e.target.value === "true" })
              }
              className="border rounded p-2 w-full"
            >
              <option value="true">มีบริการเก็บเงินปลายทาง</option>
              <option value="false">ไม่มีบริการเก็บเงินปลายทาง</option>
            </select>
          </div>
        </CardContent>
