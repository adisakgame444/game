...
const SidebarAdmin = ({ user }: SidebarAdminProps) => {
  ...
  const sidebarLinks = [
    ...
    {
      href: "/admin/bank",
      icon: <CreditCard size={20} />, // แนะนำใช้ icon เกี่ยวกับการเงิน
      label: "Bank Accounts",
    },
    {
      href: "/admin/recommended-products",
      icon: <Upload size={20} />, // ใช้ icon upload
      label: "Upload Recommended",
    },
    {
      href: "/admin/recommendedBanner-products",
      icon: <Star size={20} />, // ใช้ icon upload
      label: "Upload Banner",
    },
  ];
